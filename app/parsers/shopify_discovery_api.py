...
def discover_products_json(
    *,
    ...
    urls, payloads, warnings = _discover_products_json_since_id(
        base_url=base_url,
    ...
    page_urls, page_payloads, page_warnings = _discover_products_json_page(
        base_url=base_url,
        max_products=max_products,
        timeout_sec=timeout_sec,
        max_retries=max_retries,
...
def discover_collections_all_products(
    *,
    ...
    for _ in range(safety_limit):
        ...
        products = _extract_products_list(payload)
        if not products:
            break
